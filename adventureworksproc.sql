...
/****** Object:  StoredProcedure [dbo].[uspGetBillOfMaterials]    Script Date: 6/24/2023 8:22:18 AM ******/
SET ANSI_NULLS ON
GO
...
ELSE
BEGIN
	EXEC sys.sp_updateextendedproperty @name=N'MS_Description', @value=N'Input parameter for the stored procedure uspGetBillOfMaterials. Enter a valid ProductID from the Production.Product table.' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'uspGetBillOfMaterials', @level2type=N'PARAMETER',@level2name=N'@StartProductID'
END
GO
